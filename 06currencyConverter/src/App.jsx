...
function App() {
  ...
  return (
    ...
    >   
        <h1 className="mt-[-200px] text-white text-[64px] shadow">Currecny Converter</h1>
        <div className="w-full">
            <div className="w-full max-w-md mx-auto mt-[-350px] border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        convert()
